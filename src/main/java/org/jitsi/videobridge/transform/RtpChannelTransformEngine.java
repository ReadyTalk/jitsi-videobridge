    ...
    extends TransformEngineChain
{
     ...
     */
    private org.jitsi.videobridge.rewriting.SsrcRewritingEngine ssrcRewritingEngine;
    ...
    private TransformEngine[] createChain()
    {
        ...
        if (channel instanceof VideoChannel)
        {
            ...
            ssrcRewritingEngine = new org.jitsi.videobridge.rewriting.SsrcRewritingEngine(videoChannel);
